...
addBlock(1338,"Invisible Block (Editor)",false,{"InvisibleBlock1"})
...
addBlock(3,"Brick",true,{"Brick"})
    ...
    addBlock:attribute("eventswitch",{"pswitch","true",4})
addBlock(4,"Coin",false,{"Coin1","Coin1","Coin1","Coin2","Coin3","Coin2"})
    addBlock:attribute("coin",true)
    addBlock:attribute("eventswitch",{"pswitch","true",3})
...
addBlock(150,"On/Off Switch",true,{"OnSwitch_1","OnSwitch_1","OnSwitch_1","OnSwitch_2","OnSwitch_2","OnSwitch_2"})
    ...
    addBlock:attribute("containing",{type="event",target="onoff",value=false})
addBlock(15000,"Off Switch",true,{"OffSwitch_1","OffSwitch_1","OffSwitch_1","OffSwitch_2","OffSwitch_2","OffSwitch_2"})
    ...
    addBlock:attribute("containing",{type="event",target="onoff",value=true})
...
addBlock(166,"P-Block (On)",true,{"PBlock_On"})
    addBlock:attribute("eventswitch",{"pswitch","true",167})
addBlock(167,"P-Block (Off)",false,{{"PBlock_Off",2,2}})
    addBlock:attribute("eventswitch",{"pswitch","true",166})

addBlock(168,"Orange Palace Block (Empty, On)",true,{"PLO_Block_Active"})
    addBlock:attribute("eventswitch",{"ploswitch",true,169})
addBlock(169,"Orange Palace Block (Empty, Off)",false,{{"PLO_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"ploswitch",true,168})
addBlock(170,"Green Palace Block (Empty, On)",true,{"PLG_Block_Active"})
    addBlock:attribute("eventswitch",{"plgswitch",true,171})
addBlock(171,"Green Palace Block (Empty, Off)",false,{{"PLG_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"plgswitch",true,170})
addBlock(172,"Red Palace Block (Empty, On)",true,{"PLR_Block_Active"})
    addBlock:attribute("eventswitch",{"plrswitch",true,173})
addBlock(173,"Red Palace Block (Empty, Off)",false,{{"PLR_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"plrswitch",true,172})
addBlock(174,"Blue Palace Block (Empty, On)",true,{"PLB_Block_Active"})
    addBlock:attribute("eventswitch",{"plbswitch",true,175})
addBlock(175,"Blue Palace Block (Empty, Off)",false,{{"PLB_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"plbswitch",true,174})

addBlock(176,"Orange Palace Block (Item, On)",true,{"PLO_Block_Active"})
    addBlock:attribute("eventswitch",{"ploswitch",true,177})
    addBlock:attribute("containing","mushroom")
    addBlock:attribute("icon","icon_mushroom")
    addBlock:attribute("bumpable",{true,"EmptyBlock",5})
addBlock(177,"Orange Palace Block (Item, Off)",false,{{"PLO_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"ploswitch",true,176})
    addBlock:attribute("icon","icon_mushroom")
addBlock(178,"Green Palace Block (Item, On)",true,{"PLG_Block_Active"})
    addBlock:attribute("eventswitch",{"plgswitch",true,179})
    addBlock:attribute("containing","fireflower")
    addBlock:attribute("icon","icon_fireflower")
    addBlock:attribute("bumpable",{true,"EmptyBlock",5})
addBlock(179,"Green Palace Block (Item, Off)",false,{{"PLG_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"plgswitch",true,178})
    addBlock:attribute("icon","icon_fireflower")
addBlock(180,"Red Palace Block (Item, On)",true,{"PLR_Block_Active"})
    addBlock:attribute("eventswitch",{"plrswitch",true,181})
    addBlock:attribute("containing","star")
    addBlock:attribute("icon","icon_star")
    addBlock:attribute("bumpable",{true,"EmptyBlock",5})
addBlock(181,"Red Palace Block (Item, Off)",false,{{"PLR_Block_Inactive",1,1}})
    addBlock:attribute("eventswitch",{"plrswitch",true,180})
    addBlock:attribute("icon","icon_star")
addBlock(182,"Blue Palace Block (Item, On)",true,{"PLB_Block_Active"})
    addBlock:attribute("eventswitch",{"plbswitch",true,183})
    addBlock:attribute("containing","mushroom1up")
    addBlock:attribute("icon","icon_mushroom1up")
    addBlock:attribute("bumpable",{true,"EmptyBlock",5})
...
addBlock(185,"Blue Coin",false,{"Coin1Blue","Coin1Blue","Coin1Blue","Coin2Blue","Coin3Blue","Coin2Blue"})
    addBlock:attribute("coin",true)
    addBlock:attribute("eventswitch",{"pswitch","false",186})
addBlock(186,"Blue Coin (Inactive)",false,{nil})
    addBlock:attribute("eventswitch",{"pswitch","true",185})